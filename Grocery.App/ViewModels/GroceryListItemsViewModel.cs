...
namespace Grocery.App.ViewModels
{
    ...
    public partial class GroceryListItemsViewModel : BaseViewModel
    {
        ...
        public void AddProduct(Product product)
        {
            ...
            if (MyGroceryListItems.Any(i => i.ProductId == product.Id)) return;

            var newItem = new GroceryListItem(0, GroceryList.Id, product.Id, 1); // Id, GroceryListId, ProductId, Quantity
            ...
            GetAvailableProducts();
            OnGroceryListChanged(GroceryList); // reloads items
